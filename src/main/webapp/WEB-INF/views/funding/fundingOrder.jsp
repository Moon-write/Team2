                ...
                <tbody>
                    <c:forEach items="${list}" var="pd" varStatus="i">
                        ...
                        <tr style="border-bottom: 1px dotted #ccc;">
                            <td>
                                <div id="projectName">${pd.fundingName}</div>
                                <div id="productName">${pd.optionNameList2}</div>
                            </td>
                            <td>
                                <div id="productAmount">${pd.amountNum2}개</div>
                                <div id="productPrice">(${pd.amountNumPrice2}원)</div>
                                <input type="hidden" name="productAmount2" value="${pd.amountNum2}">
                                <input type="hidden" name="productPrice2" value="${pd.amountNumPrice2}">
                            </td>
                            <td>
                                <span class="sehotest">${pd.amountNumPrice2*pd.amountNum2}원</span>
                            </td>
                        </tr>
                ...
                <tfoot>
                    <tr class="tr-2">
                        <th colspan="3" style="font-size: 1.4em; height: 80px;">
                            <span>총 결제금액</span>
                            <span id="orderPrice">${tp}</span>원
                            <input type="hidden" id="totalPrice" value="${tp}"> <!--여기에 포인트 사용전 최종 주문금액 넣기-->
                            <input type="hidden" name="orderPrice"  value="${tp}">
                        </th>
                    </tr>
                </tfoot>
            </table>
